...
class DeeplabV3(object):
    _defaults = {
        ...
        #-------------------------------------------------------------------#
        "model_path"        : 'E:\\go work\\deeplabv3\\deeplabv3\\deeplabv3-plus-pytorch-main\\logs\\best_epoch_weights.pth',
        #----------------------------------------#
        #   所需要区分的类的个数+1
        #----------------------------------------#
        "num_classes"       : 3,
    ...
    def __init__(self, **kwargs):
        ...
        if self.num_classes <= 21:
            self.colors = [ (0, 0, 0), (0, 0, 0), (255, 255, 255), (128, 128, 0), (0, 0, 128), (128, 0, 128), (0, 128, 128),
