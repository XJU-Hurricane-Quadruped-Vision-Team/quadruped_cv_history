...
from experimental_ import attempt_load
from yolo_ import ClassificationModel, Detect, DetectionModel, SegmentationModel
from dataloaders_ import LoadImages
from general_ import (LOGGER, Profile, check_dataset, check_img_size, check_requirements, check_version,
...
def export_openvino(file, metadata, half, int8, data, prefix=colorstr('OpenVINO:')):
    ...
    if int8:
        ...
        from dataloaders_ import create_dataloader
        core = Core()
