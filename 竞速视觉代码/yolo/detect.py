...
from yolo.torch_utils_ import time_sync
import torch
from flag import flag_
...
from common_ import DetectMultiBackend
from dataloaders_ import IMG_FORMATS, VID_FORMATS, LoadImages, LoadScreenshots, LoadStreams
from general_ import (LOGGER, Profile, check_file, check_img_size, check_imshow, check_requirements, colorstr, cv2,
                           increment_path, non_max_suppression, print_args, scale_boxes, strip_optimizer, xyxy2xywh)
from torch_utils_ import select_device, smart_inference_mode
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='C:\\Users\Redham\Desktop\shi_jue\wu_jiguang(1)\wu_jiguang\model\\best.pt',
...
class DetectAPI:
    def __init__(self, weights='model/best.pt', data='data/coco128.yaml', imgsz=None, conf_thres=0.25,
    ...
    def run(self):
        ...
        for path, im, im0s, vid_cap, s in dataset:
            ...
            for i, det in enumerate(pred):  # per image
                ...
                if len(det):
                    # Rescale boxes from img_size to im0 size
                    # 这一段的报错被注释掉了，scale_coords函数未被定义
