...
if __name__ == "__main__":
    ...
    cap = cv2.VideoCapture('196588568-1-208.mp4')
    # img=cv2.imread('./images/0ace96c3-48481887.jpg')

    # cap = cv2.VideoCapture('YOLOP-opencv-dnn-main/images/0ace96c3-48481887.jpg)
    yolonet = yolop(confThreshold=0.1, nmsThreshold=0.35, objThreshold=0.5)
    while(True):
