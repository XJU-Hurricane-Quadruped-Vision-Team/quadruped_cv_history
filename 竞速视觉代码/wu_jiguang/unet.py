...
class Unet(object):
    _defaults = {
        ...
        #-------------------------------------------------------------------#
        "model_path"    : 'C:\\Users\Redham\Desktop\shi_jue\wu_jiguang(1)\wu_jiguang\wu_jiguang\model\\xxq_vgg_trained.pth',
        #--------------------------------#
        #   所需要区分的类的个数+1
        #--------------------------------#
        "num_classes"   : 3,
    ...
    def __init__(self, **kwargs):
        ...
        if self.num_classes <= 21:
            self.colors = [ (0, 0, 0), (255, 0, 0), (0, 0, 255), (128, 128, 0), (0, 0, 128), (128, 0, 128), (0, 128, 128),
